...
var ScrollPagination =  React.createClass({
	...
	__loadPrevPage: function () {
		...
		this.__loadingPrevPage= this.props.loadPrevPage();
	},
	...
	__loadNextPage: function () {
		...
		this.__loadingNextPage = this.props.loadNextPage();
	},
...
module.exports={ScrollPagination:ScrollPagination,ScrollPaginationPage:ScrollPaginationPage};
